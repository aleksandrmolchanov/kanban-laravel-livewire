<x-modal form-action="add">
    ...
    <x-slot name="content">
        <div>
            ...
            <input wire:model="name" wire:keydown.enter="add" type="text" name="group-name" id="group-name" autocomplete="given-name" class="mt-1 block w-full px-2 h-10 text-sm rounded-md border border-gray-300 focus:border-purple-500 focus:outline-none focus:ring-0 focus:ring-offset-0">
